...
@end
@implementation WMToipVoiceView
...
- (void)awakeFromNib{
    ...
    [self.imageView addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(showPushLish)]];
}
